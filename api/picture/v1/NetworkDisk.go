...
type GetFileListReq struct {
	g.Meta `path:"/getFileList" tags:"NetworkDisk" method:"post" summary:"列表查询网盘文件表"`
	model.NetworkDisk
}
...
type CreateFileReq struct {
	g.Meta `path:"/createFile" tags:"NetworkDisk" method:"post" summary:"添加网盘文件表"`
	*entity.NetworkDisk
}
...
type NetworkDiskEditReq struct {
	g.Meta `path:"/edit" tags:"NetworkDisk" method:"post" summary:"重命名文件"`
	*model.NetworkDisk
}
...
type BatchDeleteFileReq struct {
	g.Meta `path:"/batchDeleteFile" tags:"NetworkDisk" method:"post" summary:"批量删除文件"`
}
...
type DeleteFileReq struct {
	g.Meta `path:"/deleteFile" tags:"NetworkDisk" method:"post" summary:"删除文件"`
	model.NetworkDisk
}
...
type UnzipFileReq struct {
	g.Meta `path:"/unzipFile" tags:"NetworkDisk" method:"post" summary:"解压文件"`
	model.NetworkDisk
}
...
type MoveFileReq struct {
	g.Meta `path:"/moveFile" tags:"NetworkDisk" method:"post" summary:"文件移动"`
	model.NetworkDisk
}
...
type BatchMoveFileReq struct {
	g.Meta `path:"/batchMoveFile" tags:"NetworkDisk" method:"post" summary:"批量文件移动"`
	model.NetworkDisk
}
...
type SelectFileByFileTypeReq struct {
	g.Meta `path:"/selectFileByFileType" tags:"NetworkDisk" method:"get" summary:"通过文件类型查询文件"`
	model.NetworkDisk
}
...
type GetFileTreeReq struct {
	g.Meta `path:"/getFileTree" tags:"NetworkDisk" method:"post" summary:"获取文件树"`
}
