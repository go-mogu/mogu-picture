...
{{- define "pvc.name" -}}
{{- printf "%s-template" .Release.Name -}}
{{- end -}}
...
gen-code.top/version: {{ default (.Chart.Version) .Values.image.tag }}
gen-code.top/service: {{ .Chart.Name | quote }}
{{- end -}}

{{- define "service.labels.standard" -}}
gen-code.top/release: {{ .Release.Name | quote }}
{{- end -}}
...
gen-code.top/logs-parser: {{ .Values.logs.parser | quote }}
{{- end -}}

{{- define "service.monitoring.pod.annotations" -}}
gen-code.top/metrics-group: {{ .Values.metrics.group | quote }}
gen-code.top/metrics-path: {{ .Values.metrics.path | quote }}
{{- end -}}
