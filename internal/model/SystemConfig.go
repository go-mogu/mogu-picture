...
type SystemConfig struct {
	...
	UploadMinio               string      `json:"uploadMinio" q:"EQ" dc:"图片是否上传Minio (0:否， 1：是)"`                         //图片是否上传Minio (0:否， 1：是)
	...
	ContentPicturePriority    string      `json:"contentPicturePriority" q:"EQ" dc:"博客详情图片显示优先级（ 0:本地  1: 七牛云 2: Minio）"` //博客详情图片显示优先级（ 0:本地  1: 七牛云 2: Minio）
